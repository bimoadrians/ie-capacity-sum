...
header +=`
    ...
    <div class="col-sm pe-0">
      <div class="form-floating" id="display-line">
        <select class="form-select form-select-sm" id="date_line" name="date_line">
          <option value="ALL" selected>All</option>
        </select>
        <label for="date_line">Line :</label>
      </div>
    </div>
    <div class="col-sm pe-0">
      <div class="form-floating" id="display-style">
    ...
    <div class="col-sm pe-0">
      ...
      <button class="btn btn-sm btn-outline-dark" type="button" name="apply-filter" id="apply-filter">
         <span class="fa fa-filter" id="icon-filter"></span> Apply filter 
      </button>
    </div>
  </div>
</div>
